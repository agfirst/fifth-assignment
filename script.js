const foodDetails = document.getElementById("foodsDetail");
const singleFoodDetails = document.getElementById("foodSection");
const searchButton = document.getElementById("searchBtn");
const inputBox = document.getElementById("inputBox");

searchButton.addEventListener("click",function(){
    document.getElementById("foodsDetail").innerHTML = '';
                ...
                <div class="col d-flex justify-content-center">
                    <div class="card h-100 w-50 mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <p>${data.meals[0].strIngredient21}</p>
                            <p>${data.meals[0].strIngredient22}</p>
                            <p>${data.meals[0].strIngredient23}</p>
                            <p>${data.meals[0].strIngredient24}</p>
                            <p>${data.meals[0].strIngredient25}</p>
                        </div>
                    </div>
                </div>
            `;
